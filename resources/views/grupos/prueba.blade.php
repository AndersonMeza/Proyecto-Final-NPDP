...
<comentarios-component></comentarios-component>
...
<div id="content" class="p-4 p-md-5 pt-5">
   ...
   <form action="/publicaciones/store" method="post" enctype="multipart/form-data"> @csrf
      <div class="card">
         ...
         <div class="card-body">
            <input type="text" class="form-control kinput" name="POSTTEXTO" id="POSTTEXTO"
         ...
         <div class="card-footer">
            <div class="row">
               <div class="col-sm-6 row">
                  ...
                  <input type="date" class="col-sm-7 form-control" name="POSTFECHAENTREGA"
                     min="{{ date('Y-m-d', strtotime('-12 hours')) }}" required>
               </div>
               <div class="col-sm-6">
            ...
            <div class="card-footer text-muted">
               <div class="row">
                  ...
                  <input type="range" class="col-sm-10 form-control-range" name="PXUSAVANCE" id="PXUSAVANCE" min="0"
                     max="10">
               </div>
            </div>
         </div>
      ...
      <div class="card-footer text-muted">
         <div class="row">
            <div class="col-sm-6">
               ...
               for ($i=0; $i<$calificacion; $i++) echo ("<span class='fa fa-star checked' style='color:orange'>
                  </span>");
                  @endphp
            </div>
      ...
      <div class="card-body">
         <form action="/publicaciones_x_usuario/store" method="get">
            <div class="form-group">
               <div class="row">
                  <input type="text" class="form-control kinput col-sm-10" name="comentario"
